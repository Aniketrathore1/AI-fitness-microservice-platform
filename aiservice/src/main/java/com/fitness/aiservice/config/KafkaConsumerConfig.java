...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Activity> consumerFactory() {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "ai-recommendation-group");
        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        // Trust all packages so Jackson can deserialize Activity class
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, Activity.class.getName());
